...
# from 
from_ = u'{{ secrets.calibre.smtp.from }}'
...
# relay host
relay_host = u'{{ secrets.calibre.smtp.relay.host }}'
 
# relay port
relay_port = {{ secrets.calibre.smtp.relay.port }}
 
# relay username
relay_username = u'{{ secrets.calibre.smtp.relay.username }}'
 
# relay password
relay_password = '{{ secrets.calibre.smtp.relay.password }}'
 
# encryption
encryption = '{{ secrets.calibre.smtp.relay.encryption }}'
